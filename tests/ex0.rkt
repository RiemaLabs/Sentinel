...
; =======================================================
; this demonstrates a simplified counter-attack synthesis
; =======================================================
...
; modify tx0's input (by synthesis)
...
; ))
(define prog0 (ebc::hexstr->ebc in0)) ; parse program
(define sketch0 (synth::make-sketch/addr prog0 (hexstr->number addr-atk))) ; make sketch
(define enmtr0 (synth::make-enmtr/sketch vocab sketch0)) ; make enumerator
(printf "    # holes: ~a\n" (synth::enmtr-holes enmtr0))
(define-values (assign0 prog0-modified) (synth::next! enmtr0 #:assign? #t)) ; enumerate
(printf "    # prog0 assignment: ~a\n" assign0)
(define in0-modified (ebc::ebc->hexstr prog0-modified))
